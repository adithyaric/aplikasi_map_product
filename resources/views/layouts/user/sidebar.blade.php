...
<div class="sidebar-wrap sidebar-pushcontent">
    ...
    <div class="sidebar dark-bg">
        ...
        <div class="my-3 row">
            <div class="col-12 ">
                <div class="text-white border-0 shadow-sm card bg-opac">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-auto">
                                <figure class="avatar avatar-44 rounded-15">
                                    <img src="{{ asset('user/img/user1.jpg') }}" alt="">
                                </figure>
                            </div>
                            <div class="px-0 col align-self-center">
                    ...
                    <div class="text-white border-0 card bg-opac">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                ...
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button"
                            aria-expanded="false">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-person"></i></div>
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item nav-link" href="profile.html">
                                    <div class="rounded avatar avatar-40 icon"><i class="bi bi-calendar2"></i></div>
                                    <div class="col">Profile</div>
                                    <div class="arrow"><i class="bi bi-chevron-right"></i></div>
                                </a></li>
                            <li><a class="dropdown-item nav-link" href="settings.html">
                                    <div class="rounded avatar avatar-40 icon"><i class="bi bi-calendar-check"></i>
                                    </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="chat.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-chat-text"></i></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="notifications.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-bell"></i></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="blog.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-newspaper"></i></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="style.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-palette"></i></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="pages.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-file-earmark-text"></i></div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="signin.html" tabindex="-1">
                            <div class="rounded avatar avatar-40 icon"><i class="bi bi-box-arrow-right"></i></div>
