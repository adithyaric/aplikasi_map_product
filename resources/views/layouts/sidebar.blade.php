...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class=""><a href="{{ route('locations', ['type' => 'provinsi']) }}"><i class="fa fa-tachometer"></i> <span>Dashboard</span></a></li>
            <li><a href="{{ route('locations.index') }}"><i class="fa fa-map"></i> <span>Peta</span></a></li>
